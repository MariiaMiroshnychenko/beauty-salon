    ...
    <div class="row">
        ...
        <div class="menu">
            <ul>
                <li><a href="${pageContext.request.contextPath}/salon/admin/master-feedback"><span
                        class="fa fa-book"></span><fmt:message key="feedback"/></a></li>
        ...
        <div class="column" style="padding: 30px">
            <form method="get" action="${pageContext.request.contextPath}/salon/admin/master-feedback/master-submit">
                <label for="master"><fmt:message key="choose.master"/></label>
            ...
            <table class="table table-bordered" style="background-color: #eeeeee">
                <thead>
                <tr>
                    <th align="center"><fmt:message key="visit.date"/></th>
                    <th align="center"><fmt:message key="visit.date"/></th>
                    <th align="center"><fmt:message key="user.role.master"/></th>
                    <th align="center" style="width: 300px"><fmt:message key="feedback.text"/></th>
                    <th align="center"><fmt:message key="record.status.able"/></th>
                </tr>
                </thead>
                <tbody>
