                ...
                <a class="nav-link">
                    <c:choose>
                        <c:when test="${not empty param.master}">
                            <form method="get"
                                  action="${pageContext.request.contextPath}/salon/admin/master-reviews/master-submit">
                        ...
                        <c:otherwise>
                            <form method="get"
                                  action="${pageContext.request.contextPath}/salon/admin/master-reviews">
                                <label for="language"></label>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="column" style="padding: 30px">
            <form method="get" action="${pageContext.request.contextPath}/salon/admin/master-reviews/master-submit">
                <%--/master-submit">--%>
                <label for="master">Choose master</label>
                <select id="master" class="form-control" style="width: 250px" onchange="submit()" name="master">
